...
#define STR_ENDING "FELICIDADES!             HAS CONSEGUIDO RECOGER   TODAS LAS RESPUESTAS DE  LOS EXAMENES PERO...     ESTABAS DURMIENDO. EN LA VIDA REAL SIGUES SIENDO  UN ESTUDIANTE DE MIERDA  Y NO TE QUEDA OTRA QUE   IR A LA RECUPERACION DE  SEPTIEMBRE."
#define STR_ENDING2 "AHORA APAGA EL ORDENADOR Y PONTE A ESTUDIAR."
// ---------------------- ENGLISH ---------------------- //
#elif LANG == LANG_EN
...
#define STR_ENDING "CONGRATULATIONS! YOU HAVE GOT ALL THE ANSWERS OF    THE EXAMES BUT... JUST    IN YOUR DREAMS. IN THE    REAL LIVE YOU STILL       ARE A SHITTY STUDENT      AND YOU'LL HAVE TO        RETAKE DURING             SUMMER BREAK."
#define STR_ENDING2 "NOW TURN OFF THE PC AND  GET TO STUDY"
